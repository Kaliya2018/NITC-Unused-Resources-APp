...
import 'package:nitc_unused_resources_app/SearchProduct.dart';
import 'package:nitc_unused_resources_app/globalVar.dart';
import 'package:nitc_unused_resources_app/imageSliderScreen.dart';
import 'package:nitc_unused_resources_app/profileScreen.dart';
import 'package:nitc_unused_resources_app/uploadAdScreen.dart';
import 'package:nitc_unused_resources_app/Welcome/welcome_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getUserAddress() async {
    Position newPostiton = await Geolocator.getCurrentPosition(
